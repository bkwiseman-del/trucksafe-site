...
export async function generateMetadata({
  ...
  return {
    title: `${name} - Trucksafe Blog`,
    description: `DOT compliance articles about ${name.toLowerCase()} from Trucksafe's transportation safety experts.`,
  }
}
...
export default async function CategoryPage({
  ...
  params: { slug: string }
  searchParams: { page?: string; tag?: string; q?: string; view?: string }
}) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 px-6 bg-gradient-to-br from-[#363b57] to-[#2a2e42] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="max-w-4xl">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#dd8157]/20 border border-[#dd8157]/30 rounded-full mb-6 ml-4">
      ...
      <BlogFilters
        ...
        basePath={`/blog/categories/${params.slug}`}
      />
        ...
        <div className="max-w-7xl mx-auto">
          {articles.length === 0 ? (
            <div className="text-center py-20">
              ...
              <p className="text-gray-600 mb-6">
                No articles match your current filters in this category
              </p>
              <Link
                href={`/blog/categories/${params.slug}`}
          ...
          {totalPages > 1 && (
            <div className="mt-12 flex items-center justify-center gap-2">
              {currentPage > 1 && (
                <Link
                  href={buildCategoryPageUrl(params.slug, searchParams, currentPage - 1)}
              ...
              <div className="flex gap-2">
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((p) => {
                  ...
                  return (
                    <Link
                      key={p}
                      href={buildCategoryPageUrl(params.slug, searchParams, p)}
...
function buildCategoryPageUrl(
  ...
  return `/blog/categories/${categorySlug}${qs ? `?${qs}` : ''}`
}
